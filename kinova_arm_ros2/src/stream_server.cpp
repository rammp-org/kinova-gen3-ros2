...
namespace {
// Setpoint payload conversions. They live here rather than in message_mapping because
// only the streaming tier converts these; message_mapping is the action tier's seam.

...
using GoToPreset = kinova_arm_interfaces::action::GoToPreset;

namespace {
kinova_arm_ros2::GoToPresetServer::Registry test_registry() {
...
TEST_F(GotoPresetTest, KnownPresetPlansAndSucceeds) {
  ...
  kinova_arm_ros2::GoToPresetServer server(node, router, planner, grp, test_registry());

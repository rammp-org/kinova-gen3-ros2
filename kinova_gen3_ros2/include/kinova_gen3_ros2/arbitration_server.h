...
#include "rammp_common_interfaces/msg/control_status.hpp"
#include "rammp_common_interfaces/msg/e_stop.hpp"
#include "rammp_common_interfaces/srv/acquire_control.hpp"
#include "rammp_common_interfaces/srv/release_control.hpp"
#include "rammp_common_interfaces/srv/revoke_control.hpp"
...
public:
  using AcquireControl = rammp_common_interfaces::srv::AcquireControl;
  using ReleaseControl = rammp_common_interfaces::srv::ReleaseControl;
  using RevokeControl = rammp_common_interfaces::srv::RevokeControl;
  using EStop = rammp_common_interfaces::msg::EStop;
  using ControlStatus = rammp_common_interfaces::msg::ControlStatus;

...
int main(int argc, char** argv) {
  ...
  // kinova_gen3_description generates end_effector_link. Overridable rather than
  ...
  kinova_gen3_ros2::GoToPresetServer preset_server(node, router, planner, cb_group,
                                                  load_presets(*node));

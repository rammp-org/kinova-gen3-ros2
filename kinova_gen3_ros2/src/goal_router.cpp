...
GoalRouter::GoalRouter(ActionServerPort &default_port)
    : default_(default_port) {}
...
void GoalRouter::publish_feedback(const GoalId &id,
...
void GoalRouter::settle(const GoalId &id, const TrajectoryResult &r) {
  ...
  } // clear override before settling
  p->settle(id, r);
}
} // namespace kinova_gen3_ros2
